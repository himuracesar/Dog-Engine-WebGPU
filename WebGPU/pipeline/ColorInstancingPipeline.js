...
/**
 * ColorInstancingPipeline is a simple pipeline that renders colored vertices. 
 ...
 * @version 1.0
 */
class ColorInstancingPipeline extends DogPipeline {
    /**
     * Creates a new ColorInstancingPipeline instance.
    ...
    constructor(bindGroupLayouts = []) {
        const shader =  `
            ...
            VertexOutput {
                ...
                output.Position = camera.projectionMatrix * camera.viewMatrix * uniforms.modelMatrix[instanceIdx] * vec4f(position, 1.0);
