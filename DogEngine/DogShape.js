...
class DogShape {
     ...
     * @param {int} numVertRows - Number of vertices by row.
     * @param {int} numVertCols - Number of vertices by column.
     * @param {Vector3} delta - Separation between the different components of the axis.
     * @param {Vector3} position - Position of the vector.
    ...
    createCylinder(descriptor){
        ...
        const numVerts = (descriptor.stacks + 3) * (descriptor.slices + 1) + 2;
        const numIndices = 6 * descriptor.slices * (descriptor.stacks + 1);
    ...
    createTorus(descriptor){
        ...
        const numVerts = (descriptor.radialSegments + 1) * (descriptor.tubularSegments + 1);
        const numIndices = descriptor.radialSegments * descriptor.tubularSegments * 6;
